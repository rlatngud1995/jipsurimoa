...
/* =========================================
   ...
   /services/plumbing/chungnam/cheonan/불당동

   시·도 및 시·군·구 주소는 영어 slug 사용
   읍·면·동은 등록된 실제 한글 지역명 사용
========================================= */
...
/* =========================================
   ...
   읍·면·동이 들어오면 encodeURIComponent 처리
========================================= */
